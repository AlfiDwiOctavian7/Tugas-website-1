    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Tumbuh dan Berkembang dengan generasi Muda</h1>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="tambah.php" method="POST" role="">
              <div class="form-group">
                <input type="text" name="nim" class="form-control" id="nim" placeholder="NIM" required>
              </div>
              <div class="form-group">
                <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" placeholder="Masukan_Nama" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input type="text"name="no_hp" class="form-control" id="no_hp" placeholder="Masukan No Handphone" required>
              </div>
			  <<div class="form-group">
              ...
              <div class="text-center"><button type="submit" value="simpan" name="submit">Sent</button></div>
            </form>
          </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        while($mhs = mysqli_fetch_array($query)){
          ...
          echo "<a href='delete.php?id=".$mhs['nim']."'>Hapus</a>";
